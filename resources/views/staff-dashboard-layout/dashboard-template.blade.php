                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-3 d-none d-lg-inline"
                                    style="color:gray; font-size: 18px; font-weight: bold;"><span
                                        class="mr-3 d-none d-lg-inline"
                                        style="color: gray; font-size: 18px; font-weight: bold;">{{ $staff_basic_data[0]->firstname }}
                                        {{ $staff_basic_data[0]->lastname }}</span>
